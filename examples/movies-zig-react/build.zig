...
pub fn build(b: *std.Build) void {
    ...
    const run_step = b.step("run", "Run the movie server");
    ...
    const run_seed = b.addRunArtifact(seed);
    run_seed.step.dependOn(b.getInstallStep());

    const seed_step = b.step("run-seed", "Seed the database with sample movies");
